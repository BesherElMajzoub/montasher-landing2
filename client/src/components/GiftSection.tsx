...
const slides = [
    ...
    },
    {
        ...
        content: "تخيل أن محلك في شارع مهجور. هل ستبيع؟ بالتأكيد لا. موقعك الإلكتروني بدون زوار هو مثل ذلك المحل. الإعلانات ليست 'مصروفاً' بل هي 'استثمار' لجلب الزوار. معادلة النجاح بسيطة: زوار مهتمين + عرض مغري = مبيعات مؤكدة. لا تنتظر العميل  .",
    ...
    },
    {
        ...
        content: "في السعودية، الجميع يستخدم جوجل للبحث وسناب شات . إذا ظهرت للعميل وهو يبحث عن خدمتك في جوجل، فقد كسبت نصف المعركة. وإذا ظهرت له بفيديو جذاب في سناب شات، فقد كسبت اهتمامه. نحن نساعدك لتكون في المكانين، في الوقت المناسب تماماً.",
