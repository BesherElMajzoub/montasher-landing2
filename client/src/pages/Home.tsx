  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
              ...
              <div className="neo-card p-4">
                <div className="relative w-full aspect-video rounded-xl overflow-hidden">
                  <iframe
                    ...
                    src="https://www.youtube.com/embed/-P73XwPrGGw"
        ...
        {/* Footer */}
        <footer className="py-12 bg-secondary/20 border-t border-border mt-auto">
          <div className="container text-center">
            <p className="h6 text-lg text-muted-foreground leading-loose">
              <span className="copy block md:inline">
                تم التصميم بواسطة{" "}
                <a href="http://mntsher.com/" className="text-primary font-semibold hover:underline">منتشر للتسويق الالكتروني</a> |{" "}
                <a href="http://mntsher.com/" className="text-primary font-semibold hover:underline">اطلب الحملات التسويقية الان من منتشر</a> |{" "}
                التسويق الالكتروني{" "}
                <a href="http://mntsher.com/" className="text-primary font-semibold hover:underline">منتشر</a>
              </span>
              <span className="hidden md:inline"> | </span>
              <span className="block md:inline mt-2 md:mt-0">منتشر خيارك الافضل دائما لعمل الحملات التسويقية</span>
            </p>
          </div>
        </footer>
      </div>
